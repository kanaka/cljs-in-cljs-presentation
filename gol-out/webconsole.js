...
var prompt_label_4268 = [cljs.core.str("\n"),cljs.core.str(cljs.repl.prompt.call(null))].join('');
var continue_label_4269 = [cljs.core.str(cljs.core.apply.call(null,cljs.core.str,cljs.core.repeat.call(null,(cljs.core.count.call(null,prompt_label_4268) - 4)," "))),cljs.core.str("...")].join('');
jqconsole.SetPromptLabel(prompt_label_4268,continue_label_4269);
jqconsole.Prompt("true",(function (input){
cljs.repl.read_eval_print.call(null,input);
return start_prompt.call(null,jqconsole);
}),(function (p1__4267_SHARP_){
if(cljs.core.truth_(cljs.repl.complete_form_QMARK_.call(null,p1__4267_SHARP_)))
{return false;
} else
{return 0;
}
...
var G__4271_4272 = jqconsole;
G__4271_4272.ClearPromptText();
G__4271_4272.AbortPrompt();
G__4271_4272.Write(message,"jqconsole-output");
return prompt_text;
});
webconsole.register_shortcuts = (function register_shortcuts(jqconsole,shortcut_map){
var G__4279 = cljs.core.seq.call(null,shortcut_map);
while(true){
if(G__4279)
{var vec__4280 = cljs.core.first.call(null,G__4279);
var key = cljs.core.nth.call(null,vec__4280,0,null);
var callback = cljs.core.nth.call(null,vec__4280,1,null);
jqconsole.RegisterShortcut(key,callback);
{
var G__4281 = cljs.core.next.call(null,G__4279);
G__4279 = G__4281;
continue;
}
} else
...
cljs.core._STAR_out_STAR_ = (function (p1__4273_SHARP_){
return jqconsole.Write(p1__4273_SHARP_);
});
cljs.core._STAR_rtn_STAR_ = (function (p1__4274_SHARP_){
return jqconsole.Write(p1__4274_SHARP_,"jqconsole-output");
});
cljs.core._STAR_err_STAR_ = (function (p1__4275_SHARP_){
return jqconsole.Write(p1__4275_SHARP_,"jqconsole-message-error");
});
cljs.core._STAR_print_fn_STAR_ = (function (p1__4276_SHARP_){
return cljs.core._STAR_out_STAR_.call(null,p1__4276_SHARP_);
});
...
var G__4282__delegate = function (m){
