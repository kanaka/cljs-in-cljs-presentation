...
cljs.repl.print_error = (function print_error(p__4287){
var map__4289 = p__4287;
...
var line_number = cljs.core._lookup.call(null,map__4289__$1,"\uFDD0'line-number",null);
var error = cljs.core._lookup.call(null,map__4289__$1,"\uFDD0'error",null);
...
{var _STAR_out_STAR_4297 = cljs.core._STAR_out_STAR_;
...
{try{var _STAR_out_STAR_4302_4304 = cljs.core._STAR_out_STAR_;
...
}finally {cljs.core._STAR_out_STAR_ = _STAR_out_STAR_4302_4304;
}return (new cljs.core.Keyword("\uFDD0'value")).call(null,evaluated);
}catch (e4299){if(cljs.core.instance_QMARK_.call(null,Error,e4299))
{var e = e4299;
var _STAR_out_STAR_4300 = cljs.core._STAR_out_STAR_;
try{cljs.core._STAR_out_STAR_ = cljs.core._STAR_err_STAR_;
return cljs.core.println.call(null,cljs.repl.err);
}finally {cljs.core._STAR_out_STAR_ = _STAR_out_STAR_4300;
}} else
{if("\uFDD0'else")
{throw e4299;
} else
...
return true;
}catch (e4309){if(cljs.core.instance_QMARK_.call(null,Error,e4309))
{var e = e4309;
...
cljs.core._STAR_out_STAR_ = (function (p1__4305_SHARP_){
return console.log(p1__4305_SHARP_.replace(/\n$/,""));
});
cljs.core._STAR_rtn_STAR_ = cljs.core.identity;
cljs.core._STAR_err_STAR_ = (function (p1__4306_SHARP_){
return console.error(p1__4306_SHARP_.replace(/\n$/,""));
});
return cljs.core._STAR_print_fn_STAR_ = (function (p1__4307_SHARP_){
return cljs.core._STAR_out_STAR_.call(null,p1__4307_SHARP_);
});
}
});
...
var G__4310__delegate = function (m){
